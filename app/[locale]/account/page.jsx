    ...
    <>
      <section className="relative  z-10 py-28 md:py-36 lg:py-36">
        <div className={`container ${rtl} overflow-hidden`}>
          ...
          {session ? (
            <div
              className="wow fadeInUp  relative z-10 rounded-md bg-primary/10 text-dark p-8 dark:bg-primary/10 sm:p-11 lg:p-8 xl:p-11"
              data-wow-delay=".2s"
            >
              ...
              <div className="my-10 flex    flex-col items-center justify-center gap-5 lg:flex-row lg:pr-0">
                <div className="z-50 ">
                  <ModalCard className="relative" user={user} setNewUser={setUser} />
                </div>
                ...
                <button
                  ...
                  border-dark
                  dark:border-white px-7 py-3 text-base font-bold text-dark hover:opacity-70 dark:text-white  "
                >
                  {t("logout")}
                </button>
              </div>

              <div className="flex flex-col gap-4 text-dark dark:text-body-color">
