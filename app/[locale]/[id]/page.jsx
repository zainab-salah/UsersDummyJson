...
function SingleUserDate({ params }) {
  ...
  return (
    <section
      id="home"
      className="relative  flex  justify-center z-10 overflow-hidden pb-16 pt-[120px] md:pb-[120px]
     md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px]"
    >
      <div
        className={`${rtl} wow fadeInUp relative rounded-md bg-primary/10 p-4 my-5 mx-1 lg:w-1/2 dark:bg-primary/10`}
      >
